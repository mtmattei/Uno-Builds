...
Evidence run: `run-20-full` (source commit `426cbbf`), CI outputs in `results/ci/run-20-full/`.

**PASS 94 · FAIL 1 · NOT TESTED 1**
...
| A05 | Android launches to a usable Dashboard | **PASS** | A:A05.dashboard_usable: pass<br>A:J04.clean_first_run: pass (cold start TotalTime=7161ms) |
| A06 | Windows launches to a usable Dashboard | **PASS** | W:A06.dashboard_usable: pass (client=(1440, 900))<br>W:J04.clean_first_run: pass (startup=0.72s) |
...
| B07 | Android primary navigation reaches Dashboard / Assets / History | **PASS** | A:B07.bottom_nav_assets: pass<br>A:B12.view_history: pass<br>A:C10.persisted_after_relaunch: pass (relaunch TotalTime=3186ms)<br>A:C02.counts_updated_after_save: pass<br>*bottom navigation used for all three destinations* |
...
| C10 | Inspection remains after full process termination and relaunch | **PASS** | unit tests: 47 passed, 0 failed<br>A:C10.persisted_after_relaunch: pass (relaunch TotalTime=3186ms)<br>W:C10.persisted_after_relaunch: pass (startup=0.58s)<br>*Android: am force-stop + relaunch; Windows: process kill + relaunch* |
...
| J04 | Clean install / first run succeeds | **PASS** | A:J04.clean_first_run: pass (cold start TotalTime=7161ms)<br>W:J04.clean_first_run: pass (startup=0.72s) |
| J05 | Process kill + relaunch preserves submitted inspection | **PASS** | A:C10.persisted_after_relaunch: pass (relaunch TotalTime=3186ms)<br>W:C10.persisted_after_relaunch: pass (startup=0.58s) |
...
| J09 | Primary workflow exercised end-to-end on Android and Windows | **PASS** | A:C10.persisted_after_relaunch: pass (relaunch TotalTime=3186ms)<br>W:C10.persisted_after_relaunch: pass (startup=0.58s)<br>A:B05.success: pass<br>W:B05.success: pass |
