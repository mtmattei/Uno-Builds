...
namespace ReservoomUno.ViewModels
{
    public class MakeReservationViewModel : ViewModelBase, INotifyDataErrorInfo
    {
        ...
        public MakeReservationViewModel(HotelStore hotelStore, INavigator navigator)
        {
            SubmitCommand = new MakeReservationCommand(this, hotelStore, () => _ = navigator.NavigateBackAsync(this));
