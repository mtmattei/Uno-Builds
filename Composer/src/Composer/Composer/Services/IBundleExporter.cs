...
/// <summary>
/// Saves the composition's per-layer files (plus the synthesized
/// README.md / prompt-context.md companions) as a ZIP archive — one
/// individual file per dictionary entry, picker filtered to .zip.
/// File order in the archive follows the iteration order of the
/// supplied dictionary (the model builds it in canonical layer order).
/// </summary>
