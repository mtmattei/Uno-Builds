...
public interface IAnthropicClient
{
    ...
    /// via System.Text.Json. Used by <c>FetchDesignFromScreenshotAsync</c>
    /// so the screenshot's pixels reach Sonnet's vision pipeline without us
    /// having to model a polymorphic content-block hierarchy in C#.
    /// </summary>
    [Post("/v1/messages")]
