...
public class ResultTable
{
    ...
    public Windows.Foundation.Rect BoundingRect { get; set; } = new();
    ...
    public ResultTable(ref List<WordBorderInfo> wordBorders, double dpiScaleX, double dpiScaleY)
    {
        int borderBuffer = 3;
        ...
        bordersBorder.Width = (int)(bordersBorder.Width * dpiScaleX);
        bordersBorder.Height = (int)(bordersBorder.Height * dpiScaleY);
        ...
        for (int i = 0; i < selectedBorders.Count; i++)
        {
            ...
            if (border.ResultColumnID == percentColumnId && LooksLikePlainNumber(wordToAdd))
            {
                ...
                for (int j = i + 1; j < selectedBorders.Count; j++)
                {
                    ...
                    if (nb.ResultRowID != border.ResultRowID) break;
                    if (nb.ResultColumnID != border.ResultColumnID) break;
